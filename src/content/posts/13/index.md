...
---
# Typst
Typst 是一款面向科学领域的新型标记语言排版系统，其设计目标是同时作为 LaTeX 等高级工具与 Word、Google Docs 等简易工具的替代方案。

# 伽库噚文字模板

[项目地址](https://github.com/Gakusyun/gakusyun-doc)
...
模板已经预配置了常用的设置，即使没有安装推荐字体，也能正确显示。

您只用在文档前添加下面内容，便可以开始编写内容：
